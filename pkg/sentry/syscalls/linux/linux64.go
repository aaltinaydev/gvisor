...
var AMD64 = &kernel.SyscallTable{
	...
	Table: map[uintptr]kernel.Syscall{
		...
		444: syscalls.PartiallySupported("landlock_create_ruleset", LandlockCreateRuleset, "Only LANDLOCK_CREATE_RULESET_VERSION is supported.", nil),
		445: syscalls.ErrorWithEvent("landlock_add_rule", linuxerr.ENOSYS, "", nil),
		446: syscalls.ErrorWithEvent("landlock_restrict_self", linuxerr.ENOSYS, "", nil),
	},
